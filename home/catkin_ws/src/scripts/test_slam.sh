...
sleep 5
xterm  -e  " source $SETUP_BASH; roslaunch $BASE_DIR/src/turtlebot_simulator/turtlebot_gazebo/launch/gmapping_demo.launch" &
sleep 5
...
sleep 5
xterm  -e  " source $SETUP_BASH; roslaunch $BASE_DIR/src/turtlebot/turtlebot_teleop/launch/keyboard_teleop.launch; read" 